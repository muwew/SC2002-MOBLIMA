...
public class Cinema implements Serializable {
    ...
    public Cinema(boolean isElite, CinemaClass cinemaClass, Location location, int cinemaNo){
...
//    public Cinema (boolean isElite, CinemaClass cinemaClass, Cineplex cineplex, int cinemaNo) {
//        this.seatLayout = null;
//        this.isElite = isElite;
//        this.cinemaClass = cinemaClass;
